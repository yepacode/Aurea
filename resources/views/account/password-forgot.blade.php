...
@section('title', 'Recuperar contraseña | Belleza Áurea')
...
<section style="padding:clamp(40px,7vw,80px) 20px;background:#FBF8F2;">
    <div style="max-width:440px;margin:0 auto;">
        ...
        <div style="text-align:center;margin-bottom:26px;">
            <h1 style="font-family:'Playfair Display',serif;font-size:clamp(26px,4vw,34px);font-weight:700;color:#2E2A26;margin:0;">Recuperar contraseña</h1>
            <p style="margin:10px 0 0;color:#6B6157;font-size:15px;">Ingresa tu correo y te enviaremos un enlace para restablecer tu contraseña.</p>
        </div>
        ...
        <div style="background:#FFFFFF;border:1px solid #E5DCC9;border-radius:20px;padding:clamp(24px,4vw,34px);box-shadow:0 28px 60px -40px rgba(120,92,44,.5);">
            ...
            <form method="POST" action="{{ route('customer.password.email') }}" style="display:flex;flex-direction:column;gap:16px;">
                @csrf
