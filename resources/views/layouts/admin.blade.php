            ...
            <nav class="flex-1 py-4 px-2 overflow-y-auto">
                ...
                <div class="space-y-0.5">
                    ...
                    <a href="{{ route('admin.bundles.index') }}"
                       class="flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-white/10 transition-colors text-sm {{ request()->routeIs('admin.bundles.*') ? 'bg-white/10' : '' }}">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span x-show="sidebarOpen">Kits &amp; Bundles 🎁</span>
                    </a>
